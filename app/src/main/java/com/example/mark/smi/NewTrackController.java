...
public class NewTrackController extends com.example.mark.smi.Menu {
    ...
    //When click in Next Button, load the gps activity
    public void nextGoogle(View view) {
        ...
        if (TextUtils.isEmpty(name.getText().toString().trim())) {
            ...
            Intent intent = new Intent(this, GoogleController.class);
